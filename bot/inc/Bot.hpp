...
public:
	Bot(std::string const &server_address, int server_port, std::string const &nickname, std::string const &username, std::string const &realname, std::string const &channel);
	~Bot(void);
